...
if(isset($_GET['id']) AND $_GET['id'] > 0) {
   ...
   $requser = $bdd->prepare('SELECT * FROM chef_projet WHERE id = ?');
...
<div class = "container flex">           
    ...
    <div class ="item"><?php echo '<p> <a href="deconnexion.php"> Deconnexion</a> </p>'; ?> </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/chef%20de%20projet/recherche%20par%20filtres/';" class="b"> Recherche par filtres
      	     </button> 
