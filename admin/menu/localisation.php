...
<div class = "container flex">           
	...
	<div class ="item"><?php echo '<p> <a href="http://localhost/dashboard/Tests/Stage-master(2)/Stage-master/connexion2/connexion.php"> Deconnexion</a> </p>'; ?> </div>
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/insertion/insertion_localisations/';" class="a"> Nouvelle localisation
      	     </button> 
          </div>
        ...
        <div class="BU">
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Affichage/Affichage_localisations/affichage_code.php';" class="c"> Afficher localisation
      	      </button>
