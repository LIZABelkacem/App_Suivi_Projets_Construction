...
<body> 
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/insertion/insertion_index/';" class="a"> Nouvel index
      	     </button> 
          </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Import_excel/index_date/';" class="b"> Importer index
      	     </button> 
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Affichage/Affichage_index/affichage_index.php';" class="c"> Afficher index
      	      </button>
