...
<div class ="container flex" >  
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/insertion/insertion_surface_projet/';" class="a"> Nouvelle surface_projet

			   <div class="BU">

<button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Import_excel/surface_projet/';" class="b"> Importer surface_projet
</button>
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Affichage/Affichage_surface_projet/affichage_sous_code.php';" class="c"> Afficher surface_projet
      	      </button>
