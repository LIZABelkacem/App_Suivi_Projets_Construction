...
<div class = "container flex">           
	...
	<div class ="item"><?php echo '<p> <a href="http://localhost/dashboard/Tests/Stage-master(2)/Stage-master/connexion2/connexion.php"> Deconnexion</a> </p>'; ?> </div>
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/insertion/insertion_code/';" class="a"> Nouveau code 
      	     </button> 
          </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Import_excel/code/';" class="b"> Importer code
      	     </button> 
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Affichage/Affichage_code/affichage_code.php';" class="c"> Afficher code
      	      </button>
