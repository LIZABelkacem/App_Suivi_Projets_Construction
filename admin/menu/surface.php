...
<div class ="container flex" >  
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/insertion/insertion_surface/';" class="a"> Nouvelle surface
      	     </button> 
          </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Import_excel/surface/';" class="b"> Importer surface
      	     </button> 
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/admin/Affichage/Affichage_surface/affichage_surface.php';" class="c"> Afficher surfaces
      	      </button>
