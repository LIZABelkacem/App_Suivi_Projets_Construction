...
if(isset($_FILES['import_excel']))
{
 ...
 if(in_array($file_extension, $allowed_extension))
 {
  ...
  {
   $insert_data = array(
    ':identifiant_projet'  => $row[0],
    ':identifiant_surface'  => $row[1],
    ':montant_surface'  => $row[2]

  
   );

   $query = "
    INSERT INTO surface_projet
    (identifiant_projet , identifiant_surface, montant_surface) 
    VALUES (:identifiant_projet, :identifiant_surface , :montant_surface)
    ";
