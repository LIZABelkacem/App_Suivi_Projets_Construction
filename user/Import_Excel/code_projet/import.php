 ...
 if(in_array($file_extension, $allowed_extension))
 {
  ...
  foreach($data as $row)
  {
   $insert_data = array(
    ...
    ':identifiant_code'  => $row[1],
    ':montant_code_projet'  => $row[2]

  
   );

   $query = "
    INSERT INTO code_projet
    (identifiant_projet , identifiant_code, montant_code_projet) 
    VALUES (:identifiant_projet, :identifiant_code , :montant_code_projet)
    ";
