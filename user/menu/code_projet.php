...
<div class ="container flex" >  
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/insertion/insrtion_code_projet/';" class="a"> Nouveau  code projet
      	     </button> 
          </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/Import_Excel/code_projet/';" class="b"> Importer  code projet
      	     </button> 
