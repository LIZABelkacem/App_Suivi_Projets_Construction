...
<div class ="container flex" >  
              ...
              <div class="item"><?php echo '<p> <a href="javascript:history.go(-1)"> Deconnexion</a> </p>'; ?></div>

              <div class="item"> <?php echo '<p> <a href="http://localhost/dashboard/Tests/Stage-master(2)/Stage-master/menu/menuprincipal.php"> Retour</a> </p>'; ?> </div>
              ...
              <form method="post" class = "re">
      	     ...
      	     <div class="BU">
               <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/insertion/insertion_projet/ajout_projet.php';" class="a"> Nouveau projet
              </button>
             </div>
              
             <div class="BU"> 
               <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/Import_Excel/projet/' ;" class="b"> Importer projet
              </button>
             </div> 
              
              <div class="BU">
                <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/Affichage/Affichage%20-%20projet/affichageprojet.php';" class="c"> Afficher projet 
              </button> 
              </div>
