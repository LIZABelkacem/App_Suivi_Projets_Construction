...
<div class ="container flex" >  
              ...
              <div class="item"><?php echo '<p> <a href=""> Deconnexion</a> </p>'; ?></div>
         ...
         <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/insertion/insertion_sous_code/';" class="a"> Nouveau sous code
      	     </button> 
          </div>
        ...
        <div class="BU">
      	     ...
      	     <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/Import_Excel/sous_code/';" class="b"> Importer sous code
      	     </button> 
      	...
      	<div class="BU">
      	      ...
      	      <button onclick="window.location.href = 'http://localhost/dashboard/Tests/app/user/Affichage/Affichage_sous_codes/affichage_sous_code.php';" class="c"> Afficher sous code
      	      </button>
